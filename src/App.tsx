...
import { CandlesApp } from './Candles';
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/notepad/*" element={<NotepadRoute />} />
          <Route path="/candles/*" element={<CandlesRoute />} />
